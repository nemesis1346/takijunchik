...
const uploadMp3Files = async (pathSoundFile, fileName) => {
  var blob = blobUtil.createBlob([pathSoundFile], { type: "audio/mp3" });
  // var blob = Blob([pathSoundFile], { type: "audio/mp3" });
          ...
          for (let element of newobjectList) {
            ...
            await firebase
              ...
              .set({
                ...
                mediaLenguaContent: element.mediaLenguaContent,
                spanishContent: element.spanishContent,
                kichwaContent: element.kichwaContent,
                elicitSentenceContent: element.elicitSentenceContent,
                ipaContent: element.ipaContent,
                glossesContent: element.glossesContent,
                segmentedContent: element.segmentedContent,
                //Time values
        ...
        for (const element of TIME_SLOT_LIST) {
          ...
          for (let index = 0; index < objectList.length; index++) {
            ...
            if (
              ...
              objectList[index].timeValue1Format = this.parseTimeFormat(
        ...
        for (const element of TIME_SLOT_LIST) {
          ...
          for (let index = 0; index < objectList.length; index++) {
            ...
            if (
              ...
              objectList[index].timeValue2Format = this.parseTimeFormat(
                currentElement.TIME_VALUE
              );
            }
          }
